...
app.get('/callback', async (req, res) => {
    ...
    // In a real app, you'd exchange this code for a session token here
...
app.post('/api/verify-sso', async (req, res) => {
    ...
    try {
        ...
        return successResponse(res, 200, { user: userData }, 'SSO login successful on Inventory Service');
    } catch (error) {
...
const PORT = 5002;
app.listen(PORT, () => {
    console.log(`Inventory Service (Service A) running on http://localhost:${PORT}`);
});
